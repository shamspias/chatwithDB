...
urlpatterns = [
    ...
    # Update title
    path('conversations/<int:conversation_id>/title/', views.ConversationRetrieveUpdateView.as_view(),
    ...
    # Check the status of a GPT-3 task
    # path('gpt3-task-status/<str:task_id>/', views.GPT3TaskStatus.as_view(), name='gpt3-task-status'),
]
